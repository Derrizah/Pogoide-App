        ...
        return (
            <Block card style={[styles.imageBlock, imageBlockStyle]}>
                <Placeholder
                    ...
                    Animation={Fade}
                >
                <PlaceholderMedia style={[styles.image, imageStyle]} />
                </Placeholder>
            </Block>
        );
    }
                ...
                <Block flex={1.7}>
                    <Block style={styles.title}>
                        <Placeholder
                            ...
                            Animation={Fade}
                        >
                        <PlaceholderLine size={theme.SIZES.FONT * 0.875} color={titleColor}>
                            {title}
                        </PlaceholderLine>
                        </Placeholder>
                    </Block>
...
export default withGalio(PlaceholderCard, styles);